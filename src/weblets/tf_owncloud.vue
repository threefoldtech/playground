<template>
  <weblet-layout ref="layout">
    ...
    <template #subtitle>
      Owncloud develops and provides open-source software for content collaboration, allowing teams
      to easily share and work on files seamlessly regardless of device or location.
      <a
        target="_blank"
        class="app-link"
...
async function deploy() {
  ...
  try {
    ...
    return layout.value.setStatus(
      'failed',
      normalizeError(e, 'Failed to deploy a owncloud instance.')
    )
  }
